...
public class MetodosRecuperarContrasena {
    ...
    /**
     * Metodo hace una comprobacion antes de enviar el email para recuperar la
    ...
    /**
     * Metodo genera una contraseña aleatoria temporal para enviar por correo
     * electronico al usuario
     *
     * @return String de la nueva contraseña
     */
    ...
    /**
     * Metodo en el que se le pasa el correoelectronico y el hash para guardarlo
